...
const EARTH = preload("res://Assets/Objects/Items/Earth.tscn")
const WATER = preload("res://Assets/Objects/Items/Water.tscn")
const WIND = preload("res://Assets/Objects/Items/Wind.tscn")
